 ...
 * Type: CSCDR_v1<br>
 * <br>
 * Description: Baseado no artigo do CEC, mas com mudanças no cálculo do fitness (+1 no numerador e denominador) e 
 * inserção de ab's
 * <br>
 * @author Luiz Otavio V. B. Oliveira, 2012
 *
 */
public class CSCDR_v1 extends Classifier implements OptionHandler{
...
//                range = (range * aMutationRate);
    ...
    public static void main(String[] argv){
        try{
            System.out.println(Evaluation.evaluateModel(new CSCDR_v1(), argv));
        }
        catch (Exception e){
